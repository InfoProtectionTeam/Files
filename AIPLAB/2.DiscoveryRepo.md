...
21. Type in the following command:
	...
	Set-AIPAuthentication -AppId "<CLIENTID>" -AppSecret "<SECRET>" -DelegatedUser scanner@contoso.com -TenantId "<TENANTID>" -OnBehalfOf $pscreds
	```
	...
	For your **-DelegatedUser** parameter input the AAD Admin account you are using to manage AIP. You do not need quotation marks here.
