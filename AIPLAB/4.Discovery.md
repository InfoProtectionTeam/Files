...
## Azure Information Protection (AIP) Client Windows Endpoint Auditing
...
1. In a new tab, browse to **https://security.microsoft.com/** <<Change to - https://compliance.microsoft.com>>
2. On the left side, expand **Classification** and click on **Sensitivity Labels** <<Change to - On the left pane, click on Information Protection>>
...
1. Click on the Start menu and click **Windows PowerShell** <<Run as administrator??>>
2. In the PowerShell window, type **Set-AIPFileClassification -Path C:\PII -WhatIf -DiscoveryInfoTypes All | Out-File ~\Desktop\Results.txt** <<Was copying mock pii data included in another module?>>
