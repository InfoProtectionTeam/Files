...
The scripts and sample docs used in this lab can be found at https://aka.ms/MIPFiles in the Scripts directory. The AIP Scanner scripts assume the SQL server name is AdminPC so modify as necessary if you do not use this name. The test docs are extracted to C:\PII and also staged in a shared folder called documents on AdminPC.
