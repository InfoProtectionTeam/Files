...
3. In the **Name** and **Description** boxes, type **Password** and click **Next**
...
20. On the Editing Auto labeling page, in the **Message displayed to user** text box, type **This file was automatically labeled as Confidential \ All Employees**
21. Click **Save**
...
32. On the Editing Auto labeling page, in the **Message displayed to user** text box, type **This file was automatically labeled as Highly Confidential \ All Employees**


	>![](./media/autolabel2.png)
21. Click **Save**
