...
Follow the steps outlined in the HyperV BYOL script. As a prerequisite, if you are building this particular lab you want to have the HyperV tools installed on your machine before running the script. 
